...
exports.ProgressModule = ProgressModule = __decorate([
    (0, common_1.Module)({
        imports: [typeorm_1.TypeOrmModule.forFeature([user_vocabulary_progress_entity_1.UserVocabularyProgress, vocabulary_entity_1.Vocabulary])],
        controllers: [progress_controller_1.ProgressController],
        providers: [progress_service_1.ProgressService],
        exports: [progress_service_1.ProgressService, typeorm_1.TypeOrmModule],
    })
], ProgressModule);
